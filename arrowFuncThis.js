 ...
 * 2.普通函数：函数完整的调用方法是**使用call方法**，包括test.call(context, name)和obj.greet.call(context,name)，
...
let o2 = obj2();
o2.start(); //这行代码却不会被解析成o2.start.call(o2)，因为o2.start()是一个箭头函数，它会自动做一件事：自动绑定当前调用它的外部作用域: window/global。
